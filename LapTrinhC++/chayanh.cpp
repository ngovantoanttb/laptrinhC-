...
int main()
{
	...
	while (true)
	{
		system("cls");
		cout << endl << endl;
		cout << "\t\tVIET NAM THANG HAY THUA COVID ? ";
		getline(cin, ngiu);
		if (ngiu == "THANG")
		{
			cout << "\t\t---CHINH XAC VIET NAM CHIEN THANG DAI DICH !---" << endl <<endl;
			cout << "\t\tQUYET THANG DAI DICH..." << endl;
			Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			...
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl; Sleep(1000);
			cout << "\t\tQUYET THANG DAI DICH..." << endl << endl;
			...
			while(true)
			{
				...
				ifstream file;
				file.open("E:/1.txt", ios_base::in); //import file thì copy đường dẫn rồi đổi \ thành \\ hoặc /
				string line;
